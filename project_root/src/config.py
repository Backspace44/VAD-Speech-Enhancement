...
EXPERIMENT_PRESETS = {
    "voicebank_baseline_official": {
        ...
        "description": "Official VoiceBank baseline: balanced + AdamW + OneCycleLR + MSE",
    },
    "stage2_recommended": {
        "model": "balanced_res",
        "optimizer": "adamw",
    ...
    "voicebank_quality_final": {
        ...
        "description": "Quality-oriented final VoiceBank setup: balanced_res + AdamW + OneCycleLR + MSE",
    },
}
