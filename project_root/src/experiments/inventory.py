...
OFFICIAL_CHECKPOINTS = {
    "librispeech_soft_vad_recommended_smoke": "official_librispeech_soft_vad",
...
def build_delivery_recommendations(root: Path) -> list[dict]:
    ...
    recommendations = [
        (
            ...
            "Main LibriSpeech-trained checkpoint",
        ),
        (
            "checkpoint",
            "librispeech_fast_benchmark_smoke/masknet_best.pth",
            "Fast LibriSpeech benchmark checkpoint",
        ),
        (
            "result",
        ...
        (
            ...
            "VoiceBank benchmark checkpoint comparison",
        ),
        (
            "result",
            "realtime_recordings",
