...
def generate_voicebank_metadata(split: str = 'train', data_root: Path = None) -> Dict:
    ...
    clean_dir = voicebank_root / split / "clean"
    noisy_dir = voicebank_root / split / "noisy"
        ...
        for split in args.splits:
            if split == 'val' or split in ['train', 'test']:
                ...
                if metadata:
                    ...
                    output_path = librispeech_root / f"metadata_{split}.json"
        ...
        for split in ['train', 'test']:
            if split in args.splits:
                ...
                if metadata:
                    ...
                    output_path = voicebank_root / f"metadata_{split}.json"
                    save_metadata(metadata, output_path, stats)
