...
\subsection{Antrenare Complex MaskNet pe VoiceBank}

Pentru VoiceBank-DEMAND:

\begin{lstlisting}[language=bash]
python -m src.train.train_mask_model --experiment-preset voicebank_complex_masknet
\end{lstlisting}
