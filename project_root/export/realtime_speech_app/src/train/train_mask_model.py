...
def parse_args():
    ...
    data_group.add_argument(
        ...
        default=None,
        choices=['librispeech'],
        help='Training/validation dataset. VoiceBank is reserved for benchmarking and comparisons.'
    )
    data_group.add_argument(
        '--use-vad-labels',
        action='store_true',
...
def main():
    ...
    train_loader, val_loader = create_dataloaders(
        ...
        train_noise_dir=dataset_dirs['train_noise_dir'],
        val_clean_dir=dataset_dirs['val_clean_dir'],
        val_noise_dir=dataset_dirs['val_noise_dir'],
        batch_size=config.TRAINING_CONFIG['batch_size'],
        ...
        snr_range=tuple(config.DATASET_CONFIG.get('on_the_fly_snr_range', (0.0, 20.0))),
